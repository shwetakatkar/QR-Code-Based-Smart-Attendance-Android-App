...
public class StudentProfileFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_student_profile,container,false);
        mLogout = root.findViewById(R.id.logoutButton);
        pName=root.findViewById(R.id.aName);
        pEmail=root.findViewById(R.id.pEmailAddress);
        pMobileno=root.findViewById(R.id.pMobileNumber);
        pClass=root.findViewById(R.id.pClass);
        pOrganisation=root.findViewById(R.id.pOrganizationName);
        pAddress=root.findViewById(R.id.pAddress);
        pStudentid=root.findViewById(R.id.pStudentId);
        pBdate=root.findViewById(R.id.pBirthDate);
        ...
        df.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    String studid= documentSnapshot.getString("StudentID");
